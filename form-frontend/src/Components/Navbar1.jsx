...
import SidebarLinks from './sidebar/components/Links'
import AI_logo from "../assets/Icon/AI_Logo.png";
...
const Navbar = () => {
  return (
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 border-gray-500 shadow-md  fixed w-[100%] z-100">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">

          <img src={AI_logo} class="h-[4rem]" alt="Flowbite Logo" />
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
          ...
          <SidebarLinks routes={routes} />
            ...
            <li>
              <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">KYC Verification</a>
            </li>
            <li>
              <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Certification</a>
            </li>
            <li>
