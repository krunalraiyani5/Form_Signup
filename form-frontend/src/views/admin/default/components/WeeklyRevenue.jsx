...
const WeeklyRevenue = () => {
  ...
  const training_completed = JSON.parse(
  ...
  useEffect(() => {
    const handleBeforeUnload = async (event) => {
      ...
      try {
        const response = await axios.post("http://3.110.120.207/timer", {
          email: email_user,
      ...
      {isTimeCompleted ? (
        <>
          {training_completed && exam && points ? (
            ...
            <>
              <div>
                <p className="m-5 text-[#14AE5C] text-[22px] font-bold">
                  Time Completed!
                </p>
                ...
                <div className="text-[#525252] mt-[25px] leading-normal p-[11px]">
                  ...
                  <p className="mt-[22px] text-[#525252] text-[14px] font-200 text-justify">
                    Candidate has to undergo mandatory 15 hours of Brokers’
                    Training before enrolling for the examination. Candidate has
                    to pay separately for registration of examination by paying
                    stipulated fees.
                  </p>

                  <p className="mt-[5px] text-[#525252] text-[14px] font-200 text-justify">
                    As per IRDAI (Insurance Brokers) Regulations 2018 “candidate
                    should take exam within one year from the end of the period
                    of Training”.
                  </p>
                </div>
              </div>
        ...
        <>
          <div>
            ...
            <div className="border-b border-solid ">
              ...
              <section class="timeContainer mt-[15px]">
                <div class="wrapper">
                  <div class="hours">
                    <h2 id="hours">
                      {Math.floor(elapsedTime / (60 * 60 * 1000))}{" "}
                    </h2>
                    <span class="text hours_text">HOURS</span>
                  </div>

                  <div class="">
                    <h2 id="">: </h2>
                    <span class="text hours_text"></span>
                  </div>
                  ...
                  <div class="minutes">
                    ...
                    <span class="text hours_text">MINUTES</span>
                  </div>
                  <div class="">
                    <h2 id="">: </h2>
                    <span class="text hours_text"></span>
                  ...
                  <div class="seconds">
                    <h2 id="seconds">
                      {Math.floor((elapsedTime % (60 * 1000)) / 1000)}
                    </h2>
                    <span class="text hours_text">SECONDS</span>
                  </div>
                </div>
              </section>
            </div>
            ...
            <div className="text-[#525252] mt-[25px] leading-normal p-[11px]">
              ...
              <p className="mt-[22px] text-[#525252] text-[14px] font-200 text-justify">
                Candidate has to undergo mandatory 15 hours of Brokers’ Training
                before enrolling for the examination. Candidate has to pay
                separately for registration of examination by paying stipulated
                fees.
              </p>

              <p className="mt-[5px] text-[#525252] text-[14px] font-200 text-justify">
                As per IRDAI (Insurance Brokers) Regulations 2018 “candidate
                should take exam within one year from the end of the period of
                Training”.
              </p>
            </div>
          </div>
